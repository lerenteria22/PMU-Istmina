...
with tabs[2]:
  ...
  sub_d1, sub_d2 = st.tabs(
      ["📊 Gráficas de Daño", "🗺️ Mapa de Afectaciones"]
  )
...
with tabs[3]:
  ...
  with col_v_izq:
    st.markdown(
        '<span class="chart-title">📍 Mapa de Población Vulnerable</span>',
        unsafe_allow_html=True,
    )
  ...
  with col_v_der:
    st.markdown(
        '<span class="chart-title">Concentración de Población Vulnerable por'
        " Barrio</span>",
        unsafe_allow_html=True,
    )
    df_v = (
